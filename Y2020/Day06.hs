module AdventOfCode.Y2020.Day6 where
...
parse :: Input -> [Group]
parse lines = do
   group <- breakAll null lines
   return group

questionsAnswered :: Group -> Int
questionsAnswered = length . nub . mconcat

part1 :: Input -> Int
part1 = sum . map questionsAnswered . parse


questionsShared :: Group -> Int
questionsShared = length . foldr1 intersect

part2 :: Input -> Int
part2 = sum . map questionsShared . parse
